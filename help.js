...
// capgrader-generator.js. Wired up for Capgrader Generator, Luck Simulator,
// Calculator, and MPA / Chopping Block — the button stays hidden on Base
// Builder until that tool gets its own help content.
(function () {
  ...
  const contentByTool = {
    ...
    mpa: document.querySelector('#help-content-mpa'),
  };
